...
from mr_adrish import telethn as AstrakoBotTelethonClient
from mr_adrish.modules.sql.clear_cmd_sql import get_clearcmd
from mr_adrish.modules.helper_funcs.telethn.chatstatus import user_is_admin
from mr_adrish.modules.helper_funcs.misc import delete


@MrAdrish_BotTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
